...
As we can see, new residuals are powerful now. We can conclude that there is no reason trying to optimeze this model again. 

Since there is no simple observable linear relationship in the data, we cannot build an optimal adequate model.
Other methods can be used to parse this dataset, such as the principal component analysis for example.
